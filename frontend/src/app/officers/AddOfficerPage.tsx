...
export default function AddOfficerPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    alert('অফিসার সফলভাবে যোগ করা হয়েছে!');
    navigate('/officers');
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-primary tracking-tight font-sans">নতুন অফিসার যোগ করুন</h1>
          <p className="text-sm text-on-surface-variant font-medium">সিস্টেমে নতুন একজন কর্মকর্তার তথ্য নিবন্ধিত করুন</p>
        </div>
      </div>
